...
3. **去重与动态更新**：
   - 新旧信息冲突时，以新信息为准，**直接覆盖**旧条目。冲突覆盖以“最小条目”为单位：只替换冲突的那一条，不要重写整个章节。
...
- 保证结构的完整程度：不可省略[长期事实]至[当前人物状态]中的任何一个结构项。
...
- ...
[关键共同经历](具有“里程碑”意义的过去事件，里程碑标准：关系定义变化 / 承诺形成或解除 / 重大冲突与和解 / 决策转折 / 首次类事件（只记录重要的、对关系边界有影响的，如约会）)
- ...
[待办](只记录明确承诺或明确行动计划)
- ...
[当前场景](时间、地点、天气、环境氛围等)
